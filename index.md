    ...
    {% if section.pdfs %}
      ...
      <ul>
        {% for pdf in section.pdfs %}
          <li>
            <a href="{{ site.baseurl }}/assets/uploads/{{ pdf.filename }}" target="_blank">
              {{ pdf.display_name | default: pdf.filename }}
            </a>
            <iframe src="{{ site.baseurl }}/assets/uploads/{{ pdf.filename }}" 
                    width="100%" height="500px" style="border: 1px solid #444; margin-top: 10px;"></iframe>
          </li>
        {% endfor %}
      </ul>
    {% endif %}
